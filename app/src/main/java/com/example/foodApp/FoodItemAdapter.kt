...
//        val drink: ModelMenu = drinksList[position]
...
//    fun clearDrink(drinks: java.util.ArrayList<ModelMenu>) {
//        menuList.clear()
//        menuList.addAll(drinks)
//        notifyDataSetChanged()
//    }
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val addShopping= itemView.findViewById<ImageButton>(R.id.imgBtnAddShopping)
    }
}